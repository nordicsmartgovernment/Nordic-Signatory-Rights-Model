...
```mermaid
 %%{init:{'flowchart':{'nodeSpacing': 30, 'rankSpacing': 95, 'htmlLabels': false}}}%%
    classDiagram
        ...
        Role Based Representation Rule --> "1..1" SKOSConcept<<EXTERNAL>> : role holder quantifier
        ...
        Membership Based Representation Rule --> "1..1" SKOSConcept<<EXTERNAL>> : roleHolderQuantifier
